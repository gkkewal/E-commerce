    ...
    if(isset($_POST["Submit"]))
{
    ...
    elseif(strlen($offer)>45){
        ...
        global $ConnectingDB;
        $sql = "insert into offers(offer,s_date,e_date,discount,status)";
        $sql .= "values(:Offer,:S_date,:E_date,:Discount,:sTatus)";
        $stmt = $ConnectingDB->prepare($sql);
        $stmt->bindValue(':Offer',$offer);
        $stmt->bindValue(':S_date',$s_date);
        $stmt->bindValue(':E_date',$e_date);
...
<body>
    ...
    <header class="bg-dark text-white text-center">
        <div class="container">
            <div class="row">
                ...
                <h1><i class="fa fa-edit" style="color:#27aae1;"></i>Manage Offers</h1>
            </div>
        </div>
    </header>
    <!-- HEADER-END -->
        ...
        <div class="row">
            <div class="offset-lg-1-col-lg-10 foot">
                <?php echo ErrorMessage();
                      echo SuccessMessage();
                ?>
                <form class="" action="Offer.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body bg-dark">
                            ...
                            <div class="form-group">
                                ...
                                <!-- <input class="form-control" type="number" name="e_date" id="title"
                                    placeholder="Type Price Here" value=""> --> &nbsp;
                                    <input type="date" id="start" name="trip-end" value=""
                                        min="2022-01-01" max="2022-12-31">
                            </div>
                            <div class="form-group">
    ...
    <input type="checkbox" class="form-check-input " <?php if($Status==1){echo "checked";}?> onclick="toggleOffer(<?php echo $Id;?>)" id="check">
    <!-- <label class="custom-control-label" for="switch1">Toggle me</label> -->
  </div>
    </td>
    <td>
        <a href="EditOffer.php?id=<?php echo $Id;?>" ><span class="btn btn-warning"> Edit</span></a>
        <a href="Delete.php?id=<?php echo $Id;?>&type=offer" ><span class="btn btn-danger">Delete</span></a>
    </td>
    </tr>
    </tbody>
    <?php
